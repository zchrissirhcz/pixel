...
TEST(shift, vshr_n_s8)
{
    ...
    int8_t expected_out[8] = {  1,   2,   -2,   -2,   63,   32,   31,   16};
#else
...
TEST(shift, vshl_n_s8)
{
    const int n = 2;
#if __ARM_NEON
    int8x8_t v1 = {12, 34, 56, 78, 101, 123, -12, -120};
    int8x8_t v_out = vshl_n_s8(v1, n);
#else
    pxl::int8x8_t pv1 = {12, 34, 56, 78, 101, 123, -12, -120};
    //pxl::int8x8_t pv2 = {1, 2, 3, 4, 5, 6, 7, 8};
    pxl::int8x8_t pv_out = pxl::vshl_s8(pv1, n);
#endif
    int8_t expected_out[8] = {  48,   -120,   -32,   56,   -108,   -20,   -48,   32};
