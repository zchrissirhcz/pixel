...
elseif (OVERLOOK_ARCH STREQUAL arm)
  # determine ARCH from compiler name
  if ( (CMAKE_C_COMPILER MATCHES "aarch64-linux-gnu-gcc") OR (CMAKE_CXX_COMPILER MATCHES "aarch64-linux-gnu-g++") )
    set(OVERLOOK_ABI "aarch64")
  elseif ( (CMAKE_C_COMPILER MATCHES "arm-linux-gnueabihf-gcc") OR (CMAKE_CXX_COMPILER MATCHES "arm-linux-gnueabihf-g++") )
    set(OVERLOOK_ABI "arm-eabihf")
  elseif ( (CMAKE_C_COMPILER MATCHES "aarch64-none-linux-gnu-gcc") OR (CMAKE_CXX_COMPILER MATCHES "aarch64-none-linux-gnu-g++") )
    set(OVERLOOK_ABI "aarch64")
  else()
